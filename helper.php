...
/**
 * @package     Joomla.Site
 * @subpackage  mod_articles_category_extended
 *
...
abstract class modArticlesCategoryHelper
{
	public static function getList(&$params)
	{
		...
		$time_slot = $params->get('time_slot', 1);
		if ($date_filtering !== 'off') {
			...
			if ((int)$time_slot) {
				...
				if ($time_slot == 1) {
					...
					$articles->setState('filter.start_date_range', $nowDate);
					$articles->setState('filter.end_date_range', '9999-12-31 23:59:59');
				} elseif ($time_slot == 2) {
					// only past articles
					$articles->setState('filter.start_date_range', '1000-01-01 00:00:00');
					$articles->setState('filter.end_date_range', $nowDate);
				}
			} else {
